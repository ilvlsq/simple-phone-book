/*
  ...
  - Changed the type of `ownerId` on the `PhoneBookContact` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
